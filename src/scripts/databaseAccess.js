...
export const fetchTeams = () => {
    return fetch("https://truncheons-flagons-api-nb4na.ondigitalocean.app/teams")
...
export const fetchPlayers = () => {
    return fetch("https://truncheons-flagons-api-nb4na.ondigitalocean.app/players")
        .then(response => response.json())
        .then(data => {
...
export const fetchScores = () => {
    return fetch("https://truncheons-flagons-api-nb4na.ondigitalocean.app/scores")
        .then(response => response.json())
        .then(data => {
...
export const sendCurrentScores = (currentScore1) => {
    ...
    return fetch("https://truncheons-flagons-api-nb4na.ondigitalocean.app/scores", fetchOptions)
        .then(response => response.json())
        .then(() => {
